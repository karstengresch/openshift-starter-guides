...
kind: Pipeline
metadata:
  name: nationalparks-java-pipeline
spec:
  params:
    - default: nationalparks-java
      name: APP_NAME
      type: string
...
Inside *Persistent Volume Claim name* insert:
